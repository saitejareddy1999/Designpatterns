...
public class Student {
    ...
    public static Builder getBuilder(){
        return new Builder();
    }//here student class should know the Designpatterns.builder class with new object
    static class Builder {
        ...
        public Builder setName(String name) {//here if we not return Designpatterns.builder object with another
